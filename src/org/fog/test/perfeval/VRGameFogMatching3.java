...
public class VRGameFogMatching3 {
...
//        }
		...
		try {
			...
			if(CLOUD)
			{
				...
				moduleMapping_0.addModuleToDevice("detecting_classifying",	 			"cloud");
				moduleMapping_0.addModuleToDevice("lightCNN", 			"tier-server2");
				moduleMapping_0.addModuleToDevice("high_quali_encod", 			"e-0-7");
				moduleMapping_0.addModuleToDevice("packaging", 			"tier-server1");*/
				 ...
				 * EdgeOnly
				 */
				/*moduleMapping_0.addModuleToDevice("transcoding", 			"e-0-7");
				moduleMapping_0.addModuleToDevice("permanent_storing", 			"e-0-7");
				//moduleMapping_0.addModuleToDevice("detecting_classifying", 			"e-0-5");
				moduleMapping_0.addModuleToDevice("high_quali_encod", 			"e-0-7");
				moduleMapping_0.addModuleToDevice("lightCNN", 			"e-0-7");
				moduleMapping_0.addModuleToDevice("packaging", 			"e-0-7");*/
			}
			else
			{	
				 /**
				 ...
				 */
				 ...
				 //moduleMapping_0.addModuleToDevice("image_blender", 			"tier-server");//
				 /**
				 * iFogSim method
				 */
...
//							:(new ModulePlacementEdgewards(fogDevices, sensors, actuators, application_vs, moduleMapping_0)));
	...
	private static double random(double d){
	    ...
	    ////System.out.println("Randddd "+flt);
	...
	private static void create_ds_sensor(FogDevice edge, int userId0, String app_ds, double delay) {
		...
		Sensor caSensor = new Sensor("s-"+app_ds, "CAMERA", userId0, app_ds, 
				new DeterministicDistribution(100+(random(-362064))));//1000//100+(random(-113108))//78700 
...
//////////////////////////////////////////tier.setSiblingId(cloud.getId()); 
		...
		///////////////////////////////////
		//String edgeId8 = id+"-"+8;//
		FogDevice edge8 = addedge("e-0-8", userId0, appId0, appId1, appId2, -1, 0+8); // adding edges to the physical topology. Smartphones have been modeled as fog devices as well.
		edge8.setUplinkLatency(63);
		//edge8.setUplinkLatency(3);
		fogDevices.add(edge8);
		//String edgeId7 = id+"-"+7;
		FogDevice edge7 = addedge("e-0-7", userId0, appId0, appId1, appId2,  tier2.getId() ,  0+7); // adding edges to the physical topology. Smartphones have been modeled as fog devices as well.
		edge7.setUplinkLatency(63);  
		fogDevices.add(edge7);
		
		///////////////////////////////////
		//String edgeId9 = id+"-"+9;//
		FogDevice edge9 = addedge("e-0-9", userId0, appId0, appId1, appId2, -1, 0+9); // adding edges to the physical topology. Smartphones have been modeled as fog devices as well.
		fogDevices.add(edge9);
		

		tier1.setParentId(-1); 
		tier1.setUplinkLatency(3); 
		//tier2.setParentId(edge9.getId());
		
		tier2.setParentId(tier1.getId()); 
		//tier2.setUplinkLatency(3); 
		//tier2.setParentId(cloud.getId()); 
		tier2.setUplinkLatency(60);   
		
		edge7.setParentId(tier2.getId());
